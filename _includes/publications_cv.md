...
* C227. Xizhe Shi, Zizheng Guo, Zuodong Zhang, Yun Liang, Runsheng Wang\* and **Yibo Lin**\*, "HeteroPower: A CPU-GPU Heterogeneous Engine to Accelerate Gate-Level Power Analysis," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/POWER_ISEDA2026_Shi.pdf){: .share-button-noborder})(*Best Paper Nomination*)
            
* C226. Kairong Guo, Jiechen Huang, Wenjian Yu and **Yibo Lin**\*, "CAPCell: Standard Cell Layout Synthesis with Parasitic Capacitance Aware Parallel Sampling," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/CELL_ISEDA2026_Guo.pdf){: .share-button-noborder})
            
* C225. Jincheng Lou, Ruohan Xu, Jiecheng Ma, Runzhe Tao, Xinyu Qu and **Yibo Lin**\*, "LEGO: An LLM Skill-Based Front-End Design Generation Platform," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/RTL_ISEDA2026_Lou.pdf){: .share-button-noborder})(*Best Paper Nomination*)
            
* C224. Zizhuo Fu, Yifan Zhou, Zhaoxin Lu, Guangyu Sun, Runsheng Wang, Meng Li\* and **Yibo Lin**\*, "RePart: Efficient Hypergraph Partitioning with Logic Replication Optimization for Multi-FPGA System," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/PART_ISEDA2026_Fu.pdf){: .share-button-noborder})
            
* C223. Xun Jiang, Haoran Lu, Yifan Chen, Jiarui Wang, Chunyuan Zhao, Yibo Zhang, Jianxiang Jin, Heng Wu, Runsheng Wang and **Yibo Lin**\*, "Flexible Double-Side Pin Redistribution with Efficient Virtual-Net-Guided Cell Type Assignment," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/ROUTE_ISEDA2026_Jiang.pdf){: .share-button-noborder})(*Best Paper Nomination*)
            
* C222. Haichuan Liu, Zizheng Guo, Runsheng Wang and **Yibo Lin**\*, "ElmoreCeff: A GPU-Friendly Elmore-Like Delay Calculator with a Closed-Form Effective Capacitance Model," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/TIMING_ISEDA2026_Liu.pdf){: .share-button-noborder})
            
* C221. Bingyang Liu, Haoning Jiang, Haoyi Zhang, Xiaohan Gao, Zichen Kong, Xiyuan Tang, David Z. Pan and **Yibo Lin**\*, "GRAIN: A Design-Intent-Driven Analog Layout Migration Framework," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/ANALOG_ISEDA2026_Liu.pdf){: .share-button-noborder})
...
* C216. Zizheng Guo, Runsheng Wang and **Yibo Lin**\*, "Provably Optimal Planar Pareto Nearest Neighbor Search with Double Monotone Chains," IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026. ([preprint](/publications/papers/ROUTING_DATE2026_Guo.pdf){: .share-button-noborder})
            
* C215. Jianqing Chen, Zhenkun Lin, Xun Jiang, Genggeng Liu\*, **Yibo Lin** and Gang Du, "DSR: A Systematic Approach for Efficient Double-Sided Signal Routing," IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026. ([preprint](/publications/papers/ROUTING_DATE2026_Chen.pdf){: .share-button-noborder})
            
* C214. Siting Liu, Peng Xu, Peiyu Liao, Keren Zhu, **Yibo Lin** and Bei Yu\*, "Submodular Maximization-Inspired Adaptive Routing Bend Space Planning," IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026. ([preprint](/publications/papers/ROUTING_DATE2026_Liu.pdf){: .share-button-noborder})
...
* C212. Yuhao Ji, Zizheng Guo, **Yibo Lin** and Bei Yu\*, "[HeteroSTA3D: A CPU-GPU Heterogeneous Static Timing Analysis Engine for 3D ICs](https://doi.org/10.1109/CSTIC68613.2026.11537849)," China Semiconductor Technology International Conference (CSTIC), Shanghai, Mar, 2026. ([release](https://heterosta3d.pkueda.org.cn/){: .share-button-noborder})(*Invited Paper*)
