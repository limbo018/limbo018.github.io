...
* C223. Zizhuo Fu, Yifan Zhou, Zhaoxin Lu, Guangyu Sun, Runsheng Wang, Meng Li\* and **Yibo Lin**\*, "RePart: Efficient Hypergraph Partitioning with Logic Replication Optimization for Multi-FPGA System," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/PART_ISEDA2026_Fu.pdf){: .share-button-noborder})
            
* C222. Xun Jiang, Haoran Lu, Yifan Chen, Jiarui Wang, Chunyuan Zhao, Yibo Zhang, Jianxiang Jin, Heng Wu, Runsheng Wang and **Yibo Lin**\*, "Flexible Double-Side Pin Redistribution with Efficient Virtual-Net-Guided Cell Type Assignment," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/ROUTE_ISEDA2026_Jiang.pdf){: .share-button-noborder})(*Best Paper Nomination*)
            
* C221. Haichuan Liu, Zizheng Guo, Runsheng Wang and **Yibo Lin**\*, "ElmoreCeff: A GPU-Friendly Elmore-Like Delay Calculator with a Closed-Form Effective Capacitance Model," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/TIMING_ISEDA2026_Liu.pdf){: .share-button-noborder})
            
* C220. Bingyang Liu, Haoning Jiang, Haoyi Zhang, Xiaohan Gao, Zichen Kong, Xiyuan Tang, David Z. Pan and **Yibo Lin**\*, "GRAIN: A Design-Intent-Driven Analog Layout Migration Framework," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/ANALOG_ISEDA2026_Liu.pdf){: .share-button-noborder})
            
* C219. Yuxiang Zhao, Jing Mai, Zishu Li, Haoyi Zhang, Jincheng Lou, Qing He, Runsheng Wang and **Yibo Lin**\*, "PowerCube: A Formula-in-the-Loop Framework for Cross-Stage Power Map Prediction," IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026. ([preprint](/publications/papers/POWER_ISEDA2026_Zhao.pdf){: .share-button-noborder})
