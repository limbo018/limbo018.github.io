...
* 2017
  ...
  ### J10. [Layout Synthesis for Topological Quantum Circuits with 1D and 2D Architectures](https://doi.org/10.1109/TCAD.2017.2760511) 
     * [preprint](/publications/papers/QUANTUM_TCAD2017_Lin.pdf){: .button-noborder}
  ...
  ### J9. [Sub-Resolution Assist Feature Generation with Supervised Data Learning](https://doi.org/10.1109/TCAD.2017.2748029) 
     * [preprint](/publications/papers/SRAF_TCAD2017_Xu.pdf){: .button-noborder}
  ...
  ### J8. [MrDP: Multiple-row detailed placement of heterogeneous-sized cells for advanced nodes](https://doi.org/10.1109/TCAD.2017.2748025) 
     * [preprint](/publications/papers/PLACE_TCAD2017_Lin.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MrDP/index.html){: .button-noborder}
  ...
  ### J7. [Stitch aware detailed placement for multiple e-beam lithography](http://dx.doi.org/10.1016/j.vlsi.2017.02.004) 
     * [preprint](/publications/papers/DFMP_JVLSI2017_Lin.pdf){: .button-noborder}
  ...
  ### J6. [Triple/quadruple patterning layout decomposition via linear programming and iterative rounding](http://dx.doi.org/10.1117/1.JMM.16.2.023507) 
     * [preprint](/publications/papers/MPL_JM32017_Lin.pdf){: .button-noborder}
  ...
  ### J5. [Redundant local-Loop insertion for unidirectional routing](http://dx.doi.org/10.1109/TCAD.2017.2651811) 
     * [preprint](/publications/papers/DFM_TCAD2017_Xu.pdf){: .button-noborder}
  ...
  ### J4. [Triple patterning aware detailed placement toward zero cross-row middle-of-line conflict](http://dx.doi.org/10.1109/TCAD.2017.2648843) 
     * [preprint](/publications/papers/DFMP_TCAD2017_Lin.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/TPLPlace/index.html){: .button-noborder}
...
* 2016
  ...
  ### J3. [Design for manufacturability and reliability in extreme-scaling VLSI](http://link.springer.com/article/10.1007%2Fs11432-016-5560-6) 
     * [preprint](/publications/papers/DFM_SCIS2016_Yu.pdf){: .button-noborder} \| *Invited Paper*
  ...
  ### J2. [High performance dummy fill insertion with coupling and uniformity constraints](http://dx.doi.org/10.1109/TCAD.2016.2638452) 
     * [preprint](/publications/papers/CMP_TCAD2016_Lin.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/DFI/index.html){: .button-noborder}
...
* 2015
  ...
  ### J1. [Methodology for standard cell compliance and detailed placement for triple patterning lithography](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=7036058) 
     * [preprint](/publications/papers/DFMP_TCAD2015_Yu.pdf){: .button-noborder}
...
* 2018
  ...
  ### C14. A Practical Split Manufacturing Framework for Trojan Prevention via Simultaneous Wire Lifting and Cell Insertion 
     * [preprint](/publications/papers/SPM_ASPDAC2018_Li.pdf){: .button-noborder} \| accepted
...
* 2017
  ...
  ### C13. Patterning Aware Design Optimization of Selective Etching in N5 and Beyond 
     * [preprint](/publications/papers/DFM_ICCD2017_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/DFM_ICCD2017_Lin.slides.pdf){: .button-noborder}
  ...
  ### C12. [Machine learning for mask/wafer hotspot detection and mask synthesis](http://dx.doi.org/10.1117/12.2282943) 
     * [preprint](/publications/papers/MASK_PT2017_Lin.pdf){: .button-noborder} \| *Invited paper*
  ...
  ### C11. [Placement Mitigation Techniques for Power Grid Electromigration](https://doi.org/10.1109/ISLPED.2017.8009178) 
     * [preprint](/publications/papers/DFMP_ISLPED2017_Ye.pdf){: .button-noborder}
  ...
  ### C10. [Concurrent Pin Access Optimization for Unidirectional Routing](https://doi.org/10.1145/3061639.3062214) 
     * [preprint](/publications/papers/DFMR_DAC2017_Xu.pdf){: .button-noborder}
  ...
  ### C9. [DSAR: DSA aware routing with simultaneous DSA guiding pattern and double patterning assignment](https://doi.org/10.1145/3036669.3036677) 
     * [preprint](/publications/papers/DFMR_ISPD2017_Ou.pdf){: .button-noborder}
...
* 2016
  ...
  ### C8. [MrDP: Multiple-row detailed placement of heterogeneous-sized cells for advanced nodes](http://dx.doi.org/10.1145/2966986.2967055) 
     * [preprint](/publications/papers/PLACE_ICCAD2016_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/PLACE_ICCAD2016_Lin.slides.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MrDP/index.html){: .button-noborder}
  ...
  ### C7. [A novel unified dummy fill insertion framework with SQP-based optimization method](http://dx.doi.org/10.1145/2966986.2966994) 
     * [preprint](/publications/papers/CMP_ICCAD2016_Tao.pdf){: .button-noborder}
  ...
  ### C6. [Detailed placement in advanced technology nodes: a survey](https://doi.org/10.1109/ICSICT.2016.7999056) 
     * [preprint](/publications/papers/DFMP_ICSICT2016_Lin.pdf){: .button-noborder} \| *Invited Paper*
  ...
  ### C5. [Triple/quadruple patterning layout decomposition via novel linear programming and iterative rounding](http://dx.doi.org/10.1117/12.2218628) 
     * [preprint](/publications/papers/MPL_SPIE2016_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/MPL_SPIE2016_Lin.slides.pptx){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MPLD/index.html){: .button-noborder} \| *Best Student Paper Award*
  ...
  ### C4. [Stitch aware detailed placement for multiple e-beam lithography](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?arnumber=7428009) 
     * [preprint](/publications/papers/DFMP_ASPDAC2016_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/DFMP_ASPDAC2016_Lin.slides.pptx){: .button-noborder}
...
* 2015
  ...
  ### C3. [Triple patterning aware detailed placement toward zero cross-row middle-of-line conflict](http://dl.acm.org/citation.cfm?id=2840875) 
     * [preprint](/publications/papers/DFMP_ICCAD2015_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/DFMP_ICCAD2015_Lin.slides.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/TPLPlace/index.html){: .button-noborder}
  ...
  ### C2. [High performance dummy fill insertion with coupling and uniformity constraints](http://dl.acm.org/citation.cfm?id=2744769.2744850) 
     * [preprint](/publications/papers/CMP_DAC2015_Lin.pdf){: .button-noborder} \| [slides](/publications/papers/CMP_DAC2015_Lin.slides.pdf){: .button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/DFI/index.html){: .button-noborder}
  ...
  ### C1. [Pushing multiple patterning in sub-10nm: are we ready?](http://dl.acm.org/citation.cfm?id=2744769.2747940) 
     * [preprint](/publications/papers/MPL_DAC2015_Pan.pdf){: .button-noborder} \| *Invited Paper*
