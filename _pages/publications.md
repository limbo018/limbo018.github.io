...
* 2017
  ...
  ### J10. [Layout Synthesis for Topological Quantum Circuits with 1D and 2D Architectures](https://doi.org/10.1109/TCAD.2017.2760511) 
     * [preprint](/publications/papers/J9_paper.pdf){: .share-button-noborder}
  ...
  ### J8. [MrDP: Multiple-row detailed placement of heterogeneous-sized cells for advanced nodes](https://doi.org/10.1109/TCAD.2017.2748025) 
     * [preprint](/publications/papers/J8_paper.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MrDP/index.html){: .share-button-noborder}
  ...
  ### J7. [Stitch aware detailed placement for multiple e-beam lithography](http://dx.doi.org/10.1016/j.vlsi.2017.02.004) 
     * [preprint](/publications/papers/J5_paper.pdf){: .share-button-noborder}
  ...
  ### J6. [Triple/quadruple patterning layout decomposition via linear programming and iterative rounding](http://dx.doi.org/10.1117/1.JMM.16.2.023507) 
     * [preprint](/publications/papers/J6_paper.pdf){: .share-button-noborder}
  ...
  ### J4. [Triple patterning aware detailed placement toward zero cross-row middle-of-line conflict](http://dx.doi.org/10.1109/TCAD.2017.2648843) 
     * [preprint](/publications/papers/J7_paper.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/TPLPlace/index.html){: .share-button-noborder}
...
* 2016
  ...
  ### J2. [High performance dummy fill insertion with coupling and uniformity constraints](http://dx.doi.org/10.1109/TCAD.2016.2638452) 
     * [preprint](/publications/papers/J3_paper.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/DFI/index.html){: .share-button-noborder}
...
* 2017
  ...
  ### C13. Patterning Aware Design Optimization of Selective Etching in N5 and Beyond 
     * [preprint](/publications/papers/C8_paper.pdf){: .share-button-noborder}
  ...
  ### C12. [Machine learning for mask/wafer hotspot detection and mask synthesis](http://dx.doi.org/10.1117/12.2282943) 
     * [preprint](/publications/papers/C12_paper.pdf){: .share-button-noborder} \| *Invited paper*
...
* 2016
  ...
  ### C8. [MrDP: Multiple-row detailed placement of heterogeneous-sized cells for advanced nodes](http://dx.doi.org/10.1145/2966986.2967055) 
     * [preprint](/publications/papers/C7_paper.pdf){: .share-button-noborder} \| [slides](/publications/papers/C7_slides.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MrDP/index.html){: .share-button-noborder}
  ...
  ### C6. [Detailed placement in advanced technology nodes: a survey](https://doi.org/10.1109/ICSICT.2016.7999056) 
     * [preprint](/publications/papers/C6_paper.pdf){: .share-button-noborder} \| *Invited Paper*
  ...
  ### C5. [Triple/quadruple patterning layout decomposition via novel linear programming and iterative rounding](http://dx.doi.org/10.1117/12.2218628) 
     * *Best Student Paper Award* \| [preprint](/publications/papers/C5_paper.pdf){: .share-button-noborder} \| [slides](/publications/papers/C5_slides.pptx){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/MPLD/index.html){: .share-button-noborder}
  ...
  ### C4. [Stitch aware detailed placement for multiple e-beam lithography](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?arnumber=7428009) 
     * [preprint](/publications/papers/C4_paper.pdf){: .share-button-noborder} \| [slides](/publications/papers/C4_slides.pptx){: .share-button-noborder}
...
* 2015
  ...
  ### C3. [Triple patterning aware detailed placement toward zero cross-row middle-of-line conflict](http://dl.acm.org/citation.cfm?id=2840875) 
     * [preprint](/publications/papers/C3_paper.pdf){: .share-button-noborder} \| [slides](/publications/papers/C3_slides.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/TPLPlace/index.html){: .share-button-noborder}
  ...
  ### C2. [High performance dummy fill insertion with coupling and uniformity constraints](http://dl.acm.org/citation.cfm?id=2744769.2744850) 
     * [preprint](/publications/papers/C1_paper.pdf){: .share-button-noborder} \| [slides](/publications/papers/C1_slides.pdf){: .share-button-noborder} \| [releases](http://www.cerc.utexas.edu/utda/download/DFI/index.html){: .share-button-noborder}
  ...
  ### C1. [Pushing multiple patterning in sub-10nm: are we ready?](http://dl.acm.org/citation.cfm?id=2744769.2747940) 
     * [preprint](/publications/papers/C2_paper.pdf){: .share-button-noborder} \| *Invited Paper*
