...
\textbf{会议及期刊论文} (标*表示通讯作者)
            ...
            \underline{论文成果包括: DAC (29篇), ICCAD (24篇), IEEE TCAD (30篇), DATE (15篇), ...} 
...
\item[{[C209]}]{
    ...
    ``HeteroSTA: A CPU-GPU Heterogeneous Static Timing Analysis En- gine with Holistic Industrial Design Support'', 
