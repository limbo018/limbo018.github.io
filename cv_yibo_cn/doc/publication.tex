...
\textbf{会议及期刊论文} (标*表示通讯作者)
            ...
            \underline{论文成果包括: DAC (37篇), ICCAD (24篇), IEEE TCAD (33篇), DATE (23篇), ...} 
...
\item[{[C221]}]{
    ...
    ``ElmoreCeff: An Elmore-like Delay Calculator based on a Closed-Form Effective Capacitance Model for GPU-Accelerated Timing-Driven Optimization'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Singapore, May 8-12, 2026.
    (accepted)
}
...
\item[{[C219]}]{
        Mengjia Dai, Hongduo Liu, Yuhao Ji, Xiaojing Su, \textbf{Yibo Lin} and Bei Yu*, 
    ``Soft-Constrained Triple Patterning Layout Decomposition'', 
