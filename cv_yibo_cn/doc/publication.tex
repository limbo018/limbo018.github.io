...
\item[{[J155]}]{
    ...
    ``\href{https://arxiv.org/pdf/2403.07257.pdf}{Large Circuit Models: Opportunities and Challenges}'', 
...
\item[{[P18]}]{
    ...
    Chinese Patent, CN2024101785421, Feb 09, 2024.
    (submitted)
}
...
\item[{[P17]}]{
    ...
    Chinese Patent, CN2023112735027, Jan 09, 2024.
    (submitted)
}
...
\item[{[P16]}]{
    ...
    Chinese Patent, CN2023111300780, Nov 28, 2023.
    (submitted)
}
...
\item[{[P15]}]{
    ...
    Chinese Patent, CN202310843291X, Oct 13, 2023.
    (submitted)
}
...
\item[{[P14]}]{
    ...
    Chinese Patent, CN2023101249631, Mar 28, 2023.
...
\item[{[P13]}]{
    ...
    Chinese Patent, CN2023100496576, Mar 17, 2023.
...
\item[{[P12]}]{
    ...
    Chinese Patent, CN2022112858018, Jan 03, 2023.
    (submitted)
}
...
\item[{[P11]}]{
    ...
    Chinese Patent, CN2022114229951, Dec 20, 2022.
...
\item[{[P10]}]{
    ...
    Chinese Patent, CN2021103772507, Oct 18, 2022.
    (submitted)
}
...
\item[{[P9]}]{
        \textbf{林亦波} ,  郭资政, 
    ``一种可微分时序驱动的芯片布局优化方法'', 
    Chinese Patent, CN2022107930171, Aug 05, 2022.
...
\item[{[P8]}]{
    ...
    Chinese Patent, CN2022100363194, May 17, 2022.
...
\item[{[P7]}]{
    ...
    Chinese Patent, CN2022102058942, Apr 12, 2022.
...
\item[{[P6]}]{
    ...
    ``一种老化及涨落感知的动态时序分析方法'', 
    Chinese Patent, CN2021115414669, Apr 5, 2022.
    (submitted)
}
...
\item[{[P5]}]{
        \textbf{林亦波} ,  张作栋 ,  郭资政 ,  王润声 ,  黄如, 
    ``一种基于事件传播的动态时序分析方法'', 
    Chinese Patent, CN2021109930951, Dec 24, 2021.
...
\item[{[P4]}]{
    ...
    Chinese Patent, CN2021110703249, Dec 24, 2021.
...
\item[{[P3]}]{
    ...
    Chinese Patent, CN2021105506486, Aug 27, 2021.
...
\item[{[P2]}]{
    ...
    ``一种交互式模拟电路版图编辑方法及系统'', 
    Chinese Patent, CN2021101747163, Jun 18, 2021.
...
\item[{[P1]}]{
    ...
    Chinese Patent, CN2020111436325, Jan 22, 2021.
