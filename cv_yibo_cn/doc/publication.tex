...
\item[{[C219]}]{
    ...
    ``\href{(accepted)}{Soft-Constrained Triple Patterning Layout Decomposition}'', 
...
\item[{[C218]}]{
    ...
    ``\href{(accepted)}{EMAPER: Cross-Level Electromigration Aware Placement and Routing EDA Workflow for Interconnects Hotspot Prediction and Mitigation}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C217]}]{
    ...
    ``\href{(accepted)}{SONIC: Smart Optimization for Neural-Integrated CMP with Timing-Aware Fills}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C216]}]{
    ...
    ``\href{(accepted)}{Provably Optimal Planar Pareto Nearest Neighbor Search with Double Monotone Chains}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C215]}]{
    ...
    ``\href{(accepted)}{DSR: A Systematic Approach for Efficient Double-Sided Signal Routing}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C214]}]{
    ...
    ``\href{(accepted)}{Submodular Maximization-Inspired Adaptive Routing Bend Space Planning}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C213]}]{
    ...
    ``\href{(accepted)([limbo018.github.io/papers/THERMAL_DATE2026_Zhu.pdf preprint])}{Efficient Warpage Simulation Of Complex 2.5-D/3-D IC Structures with Novel Meshing Algorithm and Layerwise Plate Theory}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C212]}]{
    ...
    ``\href{(accepted)([limbo018.github.io/papers/ANALOG_DATE2026_Liu.pdf preprint])}{GRAIN: A Design-Intent-Driven Analog Layout Migration Framework}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
