...
\item[{[P33]}]{
        \textbf{林亦波}, 江循, 吴恒, 王润声, 
    ``基于双面晶体管的拥塞线长同时感知的标准单元选型方法'', 
    中国专利, CN202511719692X, Feb 17, 2026.
    (submitted)
}
            

\item[{[P32]}]{
        \textbf{林亦波}, 刘海川, 郭资政, 张作栋, 王兆卿, 
    ``集成电路增量时序分析方法、装置和计算机设备'', 
    中国专利, CN2025114363723, Jan 30, 2026.
    (submitted)
}
...
\item[{[P31]}]{
        \textbf{林亦波}, 江循, 吴恒, 王润声, 
    ``一种基于双面晶体管的信号传输单元插入方法'', 
    中国专利, CN2025114574160, Jan 13, 2026.
    (submitted)
}
            

\item[{[P30]}]{
        余备, 蒲渊, 纪宇豪, 张作栋, 郭资政, \textbf{林亦波}, 王兆卿, 
    ``缓冲器插入方法和装置'', 
    中国专利, CN2025113264735, Dec 26, 2025.
    (submitted)
}
            

\item[{[P29]}]{
        \textbf{林亦波}, 杜宇凡, 郭资政, 张作栋, 王兆卿, 
    ``一种集成电路数字后端物理优化方法、设备、介质及产品'', 
    中国专利, CN2025116499840, Dec 12, 2025.
    (submitted)
}
            

\item[{[P28]}]{
        \textbf{林亦波}, 麦景, 赵春源, 张作栋, 王兆卿, 王润声, 
    ``集成电路合法化方法和装置'', 
    中国专利, CN2025111769595, Dec 02, 2025.
    (submitted)
}
...
\item[{[P27]}]{
        \textbf{林亦波}, 郭铠荣, 
    ``一种双面三维堆叠晶体管标准单元版图生成方法'', 
    中国专利, CN2025111087257, Nov 21, 2025.
    (submitted)
}
            

\item[{[P26]}]{
        \textbf{林亦波}, 喻文健, 张昊懿, 黄杰辰, 
    ``一种实时考虑模拟集成电路版图寄生的布线方法'', 
    中国专利, CN2025111878075, Nov 18, 2025.
    (submitted)
}
            

\item[{[P25]}]{
        \textbf{林亦波}, 赵春源, 王嘉睿, 江循, 楼锦程, 张作栋, 王兆卿, 王润声, 
    ``布线轨道分配方法、装置、计算机设备和可读存储介质'', 
    中国专利, CN202510862644X, Nov 18, 2025.
    (submitted)
}
...
\item[{[P24]}]{
        \textbf{林亦波}, 郭铠荣, 
    ``一种面向多行标准单元的层次化晶体管布局方法'', 
    中国专利, CN2025106118325, Aug 22, 2025.
    
}
            

\item[{[P23]}]{
        \textbf{林亦波}, 杜宇凡, 郭资政, 张作栋, 王润声, 
    ``芯片元件位置和尺寸调整方法'', 
    中国专利, CN2025102641639, Jun 20, 2025.
    (submitted)
}
            

\item[{[P22]}]{
        \textbf{林亦波}, 郭资政, 张作栋, 王润声, 黄如, 
    ``集成电路延迟确定方法、装置、设备、介质和产品'', 
    中国专利, CN202411597634X, Feb 18, 2025.
    (submitted)
}
...
\item[{[P21]}]{
        余备, 蒲渊, \textbf{林亦波}, 
    ``一种基于时序优化的Macro布局增量优化方法'', 
    中国专利, CN2024109403891, Nov 29, 2024.
    (submitted)
}
...
\item[{[P20]}]{
        \textbf{林亦波}, 赵春源, 张作栋, 
    ``一种3-bend模式布线方法'', 
    中国专利, CN2024108984500, Nov 29, 2024.
    (submitted)
}
...
\item[{[P19]}]{
    ...
    ``一种集成芯片稳态热仿真方法'', 
    中国专利, CN2024108520949, Oct 25, 2024.
    (submitted)
}
...
\item[{[P18]}]{
    ...
    中国专利, CN2024101785421, May 24, 2024.
...
\item[{[P6]}]{
    ...
    ``一种老化及涨落感知的动态时序分析方法'', 
    中国专利, CN2021115414669, Apr 05, 2022.
...
\textbf{会议及期刊论文} (标*表示通讯作者)
            ...
            \underline{论文成果包括: DAC (37篇), ICCAD (24篇), IEEE TCAD (34篇), DATE (21篇), ...} 
...
\item[{[J241]}]{
        Zhenkun Lin, \textbf{Yibo Lin}, Genggeng Liu* and Gang Du, 
    ``\href{https://doi.org/10.1109/TCAD.2025.3636449}{URoute: Universal Routability Prediction}'', 
...
\item[{[J240]}]{
        Xu He*, Yushan Wang, Chenjing Yang, Renjun Zhao, \textbf{Yibo Lin}, Peiyu Liao, Bei Yu, Yao Wang, Chang Liu and Yang Guo, 
    ``\href{https://doi.org/10.1145/3780100}{Efficient Timing Prediction and Optimization Using Derivable Gradient Boosting Machine Model at Placement Stage}'', 
...
\item[{[J239]}]{
        Chunyuan Zhao, Zizheng Guo, Zuodong Zhang and \textbf{Yibo Lin}*, 
    ``\href{https://doi.org/10.1109/TCAD.2025.3650401}{GAP-LA: GPU-Accelerated Performance-Driven Layer Assignment}'', 
    IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), 2026.
    (accepted)
}
...
\item[{[J238]}]{
        Xufeng Yao, Jiaxi Jiang, Yuxuan Zhao, Peiyu Liao, \textbf{Yibo Lin} and Bei Yu*, 
...
\item[{[J237]}]{
        Tianxiang Zhu, Qipan Wang, \textbf{Yibo Lin}* and Runsheng Wang*, 
    ``\href{https://doi.org/10.1109/TCAD.2026.3728619}{M2MOR: Multi-scale Thermo-mechanical Coupling Simulation of Chiplet Heterogeneous Integration Systems Based on Model Order Reduction}'', 
    IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), 2026.
    (accepted)
}
...
\item[{[C236]}]{
        Zixuan Pan, Zizheng Guo, Yufan Du, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C235]}]{
        Yi Ren, Yukun Wang, Xiang Meng, Guoyao Cheng, Baokang Peng, Lining Zhang, \textbf{Yibo Lin}, Runsheng Wang and Guangyu Sun*, 
...
\item[{[C234]}]{
        Jing Mai, Yi-Chen Lu, \textbf{Yibo Lin} and Haoxing Ren, 
...
\item[{[C233]}]{
        Wenbo An, Kairong Guo, Haoyi Zhang and \textbf{Yibo Lin}*, 
...
\item[{[C232]}]{
        Yuhao Ji, Yunqi Shi, Tianshu Hou, Yuxuan Zhao, Chunyuan Zhao, Peiyu Liao, Zizheng Guo, Chao Qian, \textbf{Yibo Lin} and Bei Yu*, 
...
\item[{[C231]}]{
        Kexing Zhou, Youwei Zhuo, \textbf{Yibo Lin}, Weikang Qian, Pengpeng Ren and Yun Liang*, 
...
\item[{[C230]}]{
        Jiechen Huang, Hector R. Rodriguez, Dingcheng Yang, Zuochang Ye, \textbf{Yibo Lin} and Wenjian Yu*, 
...
\item[{[C229]}]{
        Haoyi Zhang, Weijian Fan, Xiaohan Gao, Bingyang Liu, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C228]}]{
        Haoyi Zhang, Kairong Guo, Bojie Zhang, \textbf{Yibo Lin}* and Runsheng Wang, 
    ``\href{https://openreview.net/pdf?id=os54CnlmbR}{FusionCell: Cross-Attentive Fusion of Layout Geometry and Netlist Topology for Standard-Cell Performance Prediction}'', 
...
\item[{[C227]}]{
        Xizhe Shi, Zizheng Guo, Zuodong Zhang, Yun Liang, Runsheng Wang* and \textbf{Yibo Lin}*, 
...
\item[{[C226]}]{
        Kairong Guo, Jiechen Huang, Wenjian Yu and \textbf{Yibo Lin}*, 
...
\item[{[C225]}]{
        Jincheng Lou, Ruohan Xu, Jiecheng Ma, Runzhe Tao, Xinyu Qu and \textbf{Yibo Lin}*, 
...
\item[{[C224]}]{
        Zizhuo Fu, Yifan Zhou, Zhaoxin Lu, Guangyu Sun, Runsheng Wang, Meng Li* and \textbf{Yibo Lin}*, 
...
\item[{[C223]}]{
        Xun Jiang, Haoran Lu, Yifan Chen, Jiarui Wang, Chunyuan Zhao, Yibo Zhang, Jianxiang Jin, Heng Wu, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C222]}]{
        Haichuan Liu, Zizheng Guo, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C221]}]{
        Bingyang Liu, Haoning Jiang, Haoyi Zhang, Xiaohan Gao, Zichen Kong, Xiyuan Tang, David Z. Pan and \textbf{Yibo Lin}*, 
...
\item[{[C220]}]{
        Yuxiang Zhao, Jing Mai, Zishu Li, Haoyi Zhang, Jincheng Lou, Qing He, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C219]}]{
        Mingjun Wang, Yihan Wen, Yuntao Lu, Fengrui Liu, Yuxiang Zhao, Boyu Han, Jianan Mu, \textbf{Yibo Lin}, Runsheng Wang, Huawei Li and Bei Yu, 
    ``\href{https://openreview.net/forum?id=lEDb4gQ4dB}{CircuitNet 3.0: A Multi-Modal Dataset with Task-Oriented Augmentation for AI-Driven Circuit Design}'', 
...
\item[{[C218]}]{
        Chenglin Ye, Yuze Lu, Yizhan Liu, Ligong Zhang, Jinghan Xu, Fei Liu, \textbf{Yibo Lin}, Zheng Zhou and Xiaoyan Liu, 
    ``EMAPER: Cross-Level Electromigration Aware Placement and Routing EDA Workflow for Interconnects Hotspot Prediction and Mitigation'', 
...
\item[{[C217]}]{
        Jiajun Tan, Qichao Ma, Yiming Du, Yiming Gan, Ling Liang, \textbf{Yibo Lin}, Ming Zhu, Zongwei Wang and Yimao Cai, 
...
\item[{[C216]}]{
        Zizheng Guo, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C215]}]{
        Jianqing Chen, Zhenkun Lin, Xun Jiang, Genggeng Liu*, \textbf{Yibo Lin} and Gang Du, 
...
\item[{[C214]}]{
        Siting Liu, Peng Xu, Peiyu Liao, Keren Zhu, \textbf{Yibo Lin} and Bei Yu*, 
...
\item[{[C213]}]{
        Tianxiang Zhu, Qipan Wang, \textbf{Yibo Lin}* and Runsheng Wang*, 
    ``Efficient Warpage Simulation Of Complex 2.5-D/3-D IC Structures with Novel Meshing Algorithm and Layerwise Plate Theory'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Verona, Italy, Apr 20-22, 2026.
...
\item[{[C212]}]{
        Yuhao Ji, Zizheng Guo, \textbf{Yibo Lin} and Bei Yu*, 
    ``\href{https://doi.org/10.1109/CSTIC68613.2026.11537849}{HeteroSTA3D: A CPU-GPU Heterogeneous Static Timing Analysis Engine for 3D ICs}'', 
...
\item[{[C211]}]{
        Jiarui Wang, Runzhe Tao, Jing Mai, Xun Jiang, Shenghua Wang, Cuiliu Yang, Haoyu Jie, Kan Huang, Richard Y. Sun and \textbf{Yibo Lin}*, 
...
\item[{[C210]}]{
        Zizheng Guo, Haichuan Liu, Xizhe Shi, Shenglu Hua, Zuodong Zhang, Chunyuan Zhao, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C209]}]{
        Xizhe Shi, Zizheng Guo, \textbf{Yibo Lin}*, Zuodong Zhang, Yun Liang and Runsheng Wang*, 
...
\item[{[C208]}]{
        Kairong Guo, Haoran Lu, Rui Guo, Jiarui Wang, Chunyuan Zhao, Heng Wu, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C207]}]{
        Weijian Fan, Haoyi Zhang, Weibin Lin, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C206]}]{
        Chenhao Xue, Kezhi Li, Jiaxing Zhang, Yi Ren, Zhengyuan Shi, Chen Zhang, \textbf{Yibo Lin}, Lining Zhang, Qiang Xu and Guangyu Sun*, 
...
\item[{[C205]}]{
        Jingchao Hu, \textbf{Yibo Lin}, Hao Yu, Quan Chen, Zhou Jin* and Cheng Zhuo, 
...
\item[{[J201]}]{
        Yajuan Su, Zixi Liu, \textbf{Yibo Lin}, Xiaojing Su, Yuqin Wang, Xin Hong, Yujie Jiang, Pengyu Ren and Yayi Wei, 
    ``\href{https://doi.org/10.1109/TCAD.2025.3594247}{A Post-Routing Layout Optimization Framework for Lithography Process Window Enlargement}'', 
    IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), 2025.
    (accepted)
}
...
\item[{[J200]}]{
        Jing Mai, Chunyuan Zhao, Zuodong Zhang, Zhixiong Di, Runsheng Wang and \textbf{Yibo Lin}*, 
    ``\href{https://doi.org/10.1109/TCAD.2025.3597526}{LEGALM 2.0: A Versatile Augmented Lagrangian Method-Based Methodology for Mixed-Cell-Height Legalization}'', 
    IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems (TCAD), 2025.
    (accepted)
}
...
\item[{[C199]}]{
        Chunyuan Zhao, Jiarui Wang, Xun Jiang, Jincheng Lou and \textbf{Yibo Lin}*, 
...
\item[{[C198]}]{
        Yufan Du, Zizheng Guo, Runsheng Wang and \textbf{Yibo Lin}*, 
...
\item[{[C197]}]{
        Yuhao Ji, Yuntao Lu, Zuodong Zhang, Zizheng Guo, \textbf{Yibo Lin} and Bei Yu*, 
...
\item[{[C196]}]{
        Yuan Pu, Yuhao Ji, Siying Yu, Zuodong Zhang, Zizheng Guo, Zhuolun He, \textbf{Yibo Lin}, David Z. Pan and Bei Yu*, 
...
\item[{[C195]}]{
        Yi Ren, Baokang Peng, Chenhao Xue, Kairong Guo, Yukun Wang, Guoyao Cheng, \textbf{Yibo Lin}, Lining Zhang and Guangyu Sun*, 
...
\item[{[C192]}]{
        Chenchen Zhao, Zhengyuan Shi, Xiangyu Wen, Chengjie Liu, Yi Liu, Yunhao Zhou, Yuxiang Zhao, Hefei Feng, Yinan Zhu, Waa Gwok-Wan, Xin Cheng, Weiyu Chen, Yongqi Fu, Chujie Chen, Chenhao Xue, Ying Wang, \textbf{Yibo Lin}, Jun Yang, Ning Xu, Xi Wang and Qiang Xu*, 
...
\item[{[C190]}]{
        Yuxiang Zhao, Zhuomin Chai, Xun Jiang, Qiang Xu, Runsheng Wang and \textbf{Yibo Lin}*, 
    ``\href{https://openreview.net/forum?id=XAlUoJFFQR}{DeepLayout: Learning Neural Representations of Circuit Placement Layout}'', 
...
\item[{[C189]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11133072}{G-SpNN: GPU-Accelerated Passivity Enforcement for S-Parameter Modeling with Neural Networks}'', 
...
\item[{[C188]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11133153}{SDM-PEB: Spatial-Depthwise Mamba for Enhanced Post-Exposure Bake Simulation}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jun 22-25, 2025.
...
\item[{[C187]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11132713}{GEM: GPU-Accelerated Emulator-Inspired RTL Simulation}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jun 22-25, 2025.
    (\textbf{Best Paper Nomination})
}
...
\item[{[C186]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11133160}{A Systematic Approach for Multi-Objective Double-Side Clock Tree Synthesis}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jun 22-25, 2025.
...
\item[{[C185]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11132952}{Synergistic Die-Level Router for Multi-FPGA System with Time-Division Multiplexing Optimization}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jun 22-25, 2025.
...
\item[{[C184]}]{
    ...
    ``\href{https://doi.org/10.1109/DAC63849.2025.11132838}{RUPlace: Optimizing Routability via Unified Placement and Routing Formulation}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jun 22-25, 2025.
...
\item[{[C181]}]{
    ...
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11100627}{AnalogXpert: Automating Analog Topology Synthesis by Incorporating Circuit Design Expertise into Large Language Models}'', 
...
\item[{[C180]}]{
    ...
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11100319}{Addressing Continuity and Expressivity Limitations in Differentiable Physical Optimization: A Case Study in Gate Sizing}'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Hong Kong, May 9-12, 2025.
...
\item[{[C179]}]{
    ...
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11101126}{Multi-Row Standard Cell Layout Synthesis with Enhanced Scalability}'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Hong Kong, May 9-12, 2025.
...
\item[{[C178]}]{
    ...
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11101154}{ATSim3.5D: A Multiscale Thermal Simulator for 3.5D-IC Systems based on Nonlinear Multigrid Method}'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Hong Kong, May 9-12, 2025.
    (\textbf{Honorable Mention Paper Award})
}
...
\item[{[C177]}]{
        Chenhao Xue, Yi Ren, Jinwei Zhou, Kezhi Li, Chen Zhang, \textbf{Yibo Lin}, Lining Zhang, Qiang Xu and Guangyu Sun*, 
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11101018}{DOMAC: Differentiable Optimization for High-Speed Multipliers and Multiply-Accumulators}'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Hong Kong, May 9-12, 2025.
...
\item[{[C176]}]{
        Yi Ren, Chenhao Xue, Jiaxing Zhang, Chen Zhang, Qiang Xu, \textbf{Yibo Lin} and Guangyu Sun*, 
    ``\href{https://doi.org/10.1109/ISEDA65950.2025.11100315}{DiffuSE: Cross-Layer Design Space Exploration of DNN Accelerator via Diffusion-Driven Optimization}'', 
    IEEE/ACM International Symposium of EDA (ISEDA), Hong Kong, May 9-12, 2025.
...
\item[{[C175]}]{
    ...
    ``\href{https://doi.org/10.23919/DATE64628.2025.10993282}{A Tale of Two Sides of Wafer: Physical Implementation and Block-Level PPA on Flip FET with Dual-sided Signals}'', 
...
\item[{[C174]}]{
    ...
    ``\href{https://doi.org/10.23919/DATE64628.2025.10993234}{MORE-Stress: Model Order Reduction based Efficient Numerical Algorithm for Thermal Stress Simulation of TSV Arrays in 2.5D/3D IC}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Lyon, France, Mar 31, 2025.
...
\item[{[C173]}]{
    ...
    ``\href{https://doi.org/10.23919/DATE64628.2025.10993104}{Handling Latch Loops in Timing Analysis with Improved Complexity and Divergent Loop Detection}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Lyon, France, Mar 31, 2025.
...
\item[{[C172]}]{
    ...
    ``\href{https://doi.org/10.23919/DATE64628.2025.10993192}{SEGA-DCIM: Design Space Exploration-Guided Automatic Digital CIM Compiler with Multiple Precision Support}'', 
    IEEE/ACM Proceedings Design, Automation and Test in Europe (DATE), Lyon, France, Mar 31, 2025.
...
\item[{[C171]}]{
    ...
    ``\href{https://doi.org/10.1145/3698364.3705356}{LEGALM: Efficient Legalization for Mixed-Cell-Height Circuits with Linearized Augmented Lagrangian Method}'', 
...
\item[{[J165]}]{
        Wenshuo Yue, Teng Zhang, Zhaokun Jing, Kai Wu, Yuxiang Yang, Zhen Yang, Yongqin Wu, Weihai Bu, Kai Zheng, Jin Kang, \textbf{Yibo Lin}, Yaoyu Tao, Bonan Yan*, Ru Huang and Yuchao Yang*, 
    ``\href{https://doi.org/10.1038/s41928-024-01228-7}{A scalable universal Ising machine based on interaction-centric storage and compute-in-memory}'', 
...
\item[{[C164]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676648}{ATPlace2.5D: Analytical Thermal-Aware Chiplet Placement Framework for Large-Scale 2.5D-IC}'', 
...
\item[{[C163]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676650}{HeLEM-GR: Heterogeneous Global Routing with Linearized Exponential Multiplier Method}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
...
\item[{[C162]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676651}{HeteroExcept: A CPU-GPU Heterogeneous Algorithm to Accelerate Exception-aware Static Timing Analysis}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
...
\item[{[C161]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676664}{Joint Placement Optimization for Hierarchical Analog/Mixed-Signal Circuits}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
...
\item[{[C160]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676670}{Fusion of Global Placement and Gate Sizing with Differentiable Optimization}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
    (\textbf{Best Paper Nomination})
}
...
\item[{[C159]}]{
        Tianxiang Zhu, Qipan Wang, \textbf{Yibo Lin}*, Runsheng Wang and Ru Huang, 
    ``\href{https://doi.org/10.1145/3676536.3676738}{FaStTherm: Fast and Stable Full-Chip Transient Thermal Predictor Considering Nonlinear Effects}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
...
\item[{[C158]}]{
    ...
    ``\href{https://doi.org/10.1145/3676536.3676745}{MORPH: More Robust ASIC Placement for Hybrid Region Constraint Management}'', 
    IEEE/ACM International Conference on Computer-Aided Design (ICCAD), New Jersey, Oct, 2024.
...
\item[{[C92]}]{
    ...
    ``\href{https://doi.org/10.1145/3489517.3530675}{LHNN: Lattice Hypergraph Neural Network for VLSI Congestion Prediction}'', 
    ACM/IEEE Design Automation Conference (DAC), San Francisco, CA, Jul 10-14, 2022.
...
\item[{[C55]}]{
    ...
    ``\href{https://doi.org/10.1109/CSTIC49141.2020.9282573}{DREAMPlace 2.0: Open-Source GPU-Accelerated Global and Detailed Placement for Large-Scale VLSI Designs}'', 
...
\item[{[C50]}]{
    ...
    ``\href{https://doi.org/10.1109/ASP-DAC47756.2020.9045109}{S3DET: Detecting System Symmetry Constraints for Analog Circuits with Graph Similarity}'', 
...
\item[{[C49]}]{
    ...
    ``\href{https://doi.org/10.1109/ASP-DAC47756.2020.9045178}{High-Definition Routing Congestion Prediction for Large-Scale FPGAs}'', 
    IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC), Jan 13-16, 2020.
