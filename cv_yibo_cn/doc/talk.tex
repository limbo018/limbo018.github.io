...
\item[{[15]}]{
``PANDA: An LLM-Enhanced Performance-Driven Analog Design Framework Bridging Design Intent and Layout Generation'', in CM/IEEE Design Automation Conference (DAC), Long Beach, CA, Jul 26-29, 2026.
}

\item[{[14]}]{
``HeteroSTA: A CPU-GPU Heterogeneous Static Timing Analysis Engine with Holistic Industrial Design Support'', in IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC), Hong Kong, Jan 19-22, 2026.
}
...
\item[{[12]}]{
``Exploring Better Intra-Cell Routability for Layout Synthesis of Multi-Row Standard Cells'', in IEEE/ACM Asia and South Pacific Design Automation Conference (ASPDAC), Tokyo, Japan, Jan 20-23, 2025. 
}
...
\item[{[13]}]{
``异构并行加速物理设计技术'', 中国计算机学会芯片大会（CCF-Chip）, 无锡, Jul 17-20, 2026. 
}
